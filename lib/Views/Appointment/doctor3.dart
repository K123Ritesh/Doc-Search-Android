            ...
            decoration: BoxDecoration(
              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: isBlue ? const Color(0xFF1A6A83) : Colors.transparent,
                        border: Border.all(
                          color: const Color(0xFF1A6A83),
                          width: 2.0,
                        ),
                  ...
                  Text('Shiddhart sharma',style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400,color: const Color(0xFF1A6A83),),)
                ],
              ),
            ),
            SizedBox(
