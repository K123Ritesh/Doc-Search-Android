...
class View_Details_Page extends StatefulWidget {
  const View_Details_Page({
    super.key,
  });

  @override
  State<View_Details_Page> createState() => _View_Details_PageState();
}

class _View_Details_PageState extends State<View_Details_Page> {
