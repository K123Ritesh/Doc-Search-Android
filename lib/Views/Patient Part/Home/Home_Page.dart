...
import '../Profile/Health_Care_Plan.dart';
                          ...
                          child: Column(
                            children: [
                              Container(
                                  ...
                                  decoration: BoxDecoration(
                                    border:
                                        Border.all(color: Color(0xFF5793A8)),
                  ...
                  items: [
                    Container(
                      ...
                      child: Row(
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  width: 68.fw,
                                  margin:
                                      EdgeInsets.only(top: 10.fh, right: 60.fw),
                                  child: Material(
                                    color: Colors.white,
                                    borderRadius: BorderRadius.circular(50),
                                    child: Ink(
                            ...
                            Spacer(),
                            Container(
                              margin: EdgeInsets.only(top: 40.fh),
                              height: 108.fh,
                              // width: 158.fw,
                              child: Image.asset(
                                'assets/image 34.png',
                    ...
                    GestureDetector(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.asset('assets/Group 312.png',
                              fit: BoxFit.fill),
                        )),
                    GestureDetector(
                        onTap: () {
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Container(
                                margin:
                                    const EdgeInsets.only(top: 25, right: 35),
                                child: RichText(
                                  text: TextSpan(
                                    children: <TextSpan>[
                                      TextSpan(
